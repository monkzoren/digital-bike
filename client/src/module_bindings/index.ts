...
import MyRaceLogRow from "./my_race_log_table";
...
const tablesSchema = __schema({
  ...
  player: __table({
    ...
    indexes: [
      ...
      { accessor: 'byRace', name: 'player_race_id_idx_btree', algorithm: 'btree', columns: [
        'raceId',
      ] },
    ],
    constraints: [
  ...
  race: __table({
    ...
    indexes: [
      ...
      { accessor: 'byLobby', name: 'race_lobby_id_idx_btree', algorithm: 'btree', columns: [
        'lobbyId',
      ] },
    ],
    constraints: [
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("set_lobby_settings", SetLobbySettingsReducer),
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `myRaceLog` instead. This alias will be removed in the next major version. */
    readonly "my_race_log": Omit<typeof tablesSchema.schemaType.tables["myRaceLog"], "accessorName"> & { readonly accessorName: "my_race_log" };
  };
};
...
export type DbView = __DbViewBase & {
  /** @deprecated Use `myRaceLog` instead. This alias will be removed in the next major version. */
  readonly "my_race_log": __DbViewBase["myRaceLog"];
};

type __TablesBase = __QueryBuilder<typeof tablesSchema.schemaType>;
export type Tables = __TablesBase & {
  /** @deprecated Use `myRaceLog` instead. This alias will be removed in the next major version. */
  readonly "my_race_log": __TablesBase["myRaceLog"];
};
