...
DB_NAME="${DATABASE_NAME:-digital-bike}"
...
MINT_ISSUER="digital-bike-publisher"
...
clear_blocked() {
  ...
  echo
  echo "Player progression (level, XP, MMR) survives a wipe IF the 'profiles'"
  ...
  echo "Everything else — rooms, matches, brackets, betting wallets — is"
